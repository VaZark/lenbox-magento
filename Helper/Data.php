...
namespace Lenbox\CbnxPayment\Helper;
...
class Data extends AbstractHelper
{
    ...
    const XML_PATH_SYSTEM_CONFIG = "payment/lenbox_standard";
    const SUCCESS_PATH_URL = "sales/order/view";
    const SUCCESS_HISTORY_PATH_URL = "sales/order/history";
    const SUCCESS_IFRAME_PATH_URL = "lenbox/standard/success";

    const PHTML_SUCCESS_PATH_ONPAGE = "lenbox/success.qrcode.phtml";
    const PHTML_SUCCESS_PATH_IFRAME = "lenbox/success.iframe.phtml";
    ...
    /**
     * Check if lenbox payment is enabled
     *
     * @return string
     */
    ...
    public function requestApi($url, $fields, $type = "POST", $timeout = 10)
    {
        ...
        try {
            ...
            $this->log("JSON Response from Lenbox API");
            $this->log($response);
    ...
    /**
     * Update Order by Status on Lenbox api
     *
     * @param \Magento\Sales\Model\Order $order
     * @param array $consult
    ...
    /**
     * Process Refund Order by Status on Lenbox
     *
     * @param \Magento\Sales\Model\Order $order
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    ...
    /**
     * Process Paid Order by Status on Lenbox
     *
     * @param \Magento\Sales\Model\Order $order
     * @param string $authorizationId
     * @throws \Magento\Framework\Exception\LocalizedException
